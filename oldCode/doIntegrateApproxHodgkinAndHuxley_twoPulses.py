...
def main(argv):
    ...
    hhModel = ApproxHodgkinAndHuxleyModel(i=i)
    ...
    resultsFilename = 'results/integrationApproxHodgkinAndHuxley_twoPulses.npz'
    ...
    plt.savefig('figures/voltageTraceIntegrationApproxHodgkinAndHuxley_twoPulses.eps')
    plt.show()
    pdb.set_trace()
