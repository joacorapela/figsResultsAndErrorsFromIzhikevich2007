...
def main(argv):
    ...
    linestyleCoupled = "-"
    linestyleUncoupled = ":"
    resultsFilename = "results/integrationWCoupledINapIKHighThresholdI0%.02fEpsilon%.06fCouplingStartTime%.02f.npz"%(i0, epsilon, couplingStartTime)
    voltagesFigFilename = "figures/voltagesWCoupledINIKHighThresholdI0%.02fEpsilon%.06fCouplingStartTime%.02f.eps"%(i0, epsilon, couplingStartTime)
    phaseSpaceFigFilename = "figures/phaseSpaceWCoupledINIKHighThresholdI0%.02fEpsilon%.06fCouplingStartTime%.02f.eps"%(i0, epsilon, couplingStartTime)
