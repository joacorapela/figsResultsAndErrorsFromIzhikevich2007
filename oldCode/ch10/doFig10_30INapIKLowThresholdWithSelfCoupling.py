...
def main(argv):
    ...
    malkinsWConstantFilename = "results/wINapIKLowThresholdWithSelfCouplingStrength%.02fI0%.02fEpsilon%.06fCouplingStart%.02f.npz"%(selfCouplingStrength, i0, epsilon, couplingStartTime)
    ...
    figFilename = "figures/fig10_30INapIKLowThresholdWithSelfCouplingStrength%.02fI0%.02fEpsilon%.06fCouplingStart%.02f.eps"%(selfCouplingStrength, i0, epsilon, couplingStartTime)
    # figPickleFilename = "results/fig10_30INapIKLowThresholdWithSelfCouplingStrength%.02fI0%.02fEpsilon%.06fCouplingStart%.02f.pkl"%(selfCouplingStrength, i0, epsilon, couplingStartTime)
