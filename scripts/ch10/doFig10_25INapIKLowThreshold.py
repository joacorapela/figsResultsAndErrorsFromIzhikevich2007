...
def main(argv):
    ...
    linestyleCoupled = "-"
    linestyleUncoupled = ":"
    integrationFilename = "results/integrationWCoupledINapIKLowThresholdI0%.02fEpsilon%.06fCouplingStartTime%.02f.npz"%(i0, epsilon, couplingStartTime)
    figFilenamePattern = "figures/fig10_25INapIKLowThresholdI0%.02fEpsilon%.06fCouplingStart%.02f.%s"

    figFilename = figFilenamePattern%(i0, epsilon, couplingStartTime, "eps")
