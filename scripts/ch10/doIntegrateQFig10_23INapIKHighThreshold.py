...
def main(argv):
    ...
    resultsFilename = "results/integrationQINapIKHighThresholdI0%.02fEpsilon%.06fCouplingStart%.02f_oscillator%d.npz"%(i0, epsilon, couplingStartTime, oscillatorIndex)
    dt = 1e-3
    i0 = 10
    def i(t):
        return(i0)
