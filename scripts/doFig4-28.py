...
def main(argv):
    ...
    resultsFilenamePattern = 'results/integrationINapIKFig4-28PulseStrength%d.npz'
    phaseFigFilename = 'figures/fig4-28PhaseSpace.eps'
    voltageFigFilename = 'figures/fig4-28Voltage.eps'
