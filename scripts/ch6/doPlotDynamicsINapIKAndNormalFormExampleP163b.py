...
def main(argv):
    ...
    iNapIKResultsFilenamePattern = "results/integrationINapIKIExampleP163b_i0%.02fv0%.02f.npz"
    normalFormResultsFilenamePattern = "results/analyticalSolutionNormalFormExampleP163b_i0%.02fv0%.02f.npz"
    figFilename = "figures/dynamicsINapIKAndNormalFormExampleP163b.eps"
#     i0s = (-5.0,)
#     v0s = (-45.0, -57.0, -75.0)
    i0s = (3.0,)
    v0s = (-55.0,)
